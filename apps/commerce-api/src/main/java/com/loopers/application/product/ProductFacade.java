...
public class ProductFacade {
    ...
    public ProductFacade(JpaProductRepository productRepository, JpaBrandRepository brandRepository,
            JpaProductLikeRepository likeRepository, ProductService productService) {
    ...
    public ProductDetailResponse getProductDetail(Long productId) {
        ...
        ProductDetail productDetail = productService.createProductDetail(product, brand);
